      ...
      <div className="w-full h-full relative" style={{background: "url('https://d33v4339jhl8k0.cloudfront.net/docs/assets/5bbe96a22c7d3a04dd5b8761/images/5ea88836042863474d19c944/file-pR2XT8TZj1.png')"}}>
        ...
        <div
          ...
          {msgAvailable && <div className="absolute bg-blue-800 rounded-lg shadow-xl right-[75%] bottom-[75%] text-black w-fit pl-6">
            <div className="bg-white h-full py-4 pl-4 rounded-r-lg flex flex-col items-start gap-4">
              <div className="flex flex-col pr-12 gap-1">
                <span className='text-[#35388C] text-sm font-semibold uppercase tracking-wide'>Recommendation</span>
                <span className='text-[#4B5563] font-lg whitespace-nowrap'>Your patient may have <span className='font-semibold'>Diabetes Type 2</span></span>
                {visibleInsights && (
                  <>
                  <span className='text-[#35388C] text-sm font-semibold uppercase mt-4 tracking-wide'>Why</span>
                  <span className='text-[#4B5563] font-lg whitespace-nowrap'>I found 4 patients with similar history that evolved into a <span className='font-semibold'>Diabetes Type 2</span></span>
                  </>
                )}
              </div>
